...
public class ItemListAdapterGr extends ArrayAdapter<Item> {

	Context context;
	public ItemListAdapterGr(Context context, List<Item> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
			...
			convertView = li.inflate(R.layout.itemgr, null);
