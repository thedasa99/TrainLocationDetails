   ...
   ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            chapter1.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter2.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter3.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter4.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter6.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter7.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter8.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter9.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter10.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter11.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter12.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter13.setUrl("file:///android_asset/gr/gr"+id+".htm");
            ...
            chapter14.setUrl("file:///android_asset/gr/gr"+id+".htm");
